    ...
    >
      <button onClick={() => navigate('/')} className="flex items-center gap-2.5 cursor-pointer group">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-[10px] tracking-widest uppercase leading-none mt-0.5" style={{ color: '#00d4ff50' }}>
            let it out
          </span>
        </div>
      </button>
      ...
      <div className="flex items-center gap-3">
        {user ? (
          <>
            ...
            <button
              onClick={signOut}
              className="text-sm px-3 py-1.5 rounded-md transition-all duration-200 cursor-pointer hover:text-[#ff453a] hover:bg-[#ff453a10]"
              style={{ color: '#4a5568', border: '1px solid rgba(0, 212, 255, 0.06)' }}
            >
              Sign Out
            </button>
          </>
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2 rounded-md text-sm font-semibold transition-all duration-200 cursor-pointer hover:brightness-110"
            style={{
